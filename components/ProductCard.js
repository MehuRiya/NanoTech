...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col hover:border-accent/50 hover:shadow-md transition-all duration-200 group">
      {/* Image */}
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <Link href={`/product/${product.id}`} className="group/link">
          <h3 className="text-gray-900 font-semibold text-base mb-2 group-hover/link:text-accent transition-colors line-clamp-2">
            {product.name}
          </h3>
        </Link>
        ...
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-accent hover:bg-blue-500 text-white text-xs font-semibold rounded-md transition-colors duration-200"
          >

...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="bg-surface-alt border border-gray-700/60 rounded-xl overflow-hidden flex flex-col hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10 transition-all duration-200 group">
      {/* Image */}
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-700/60">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-accent hover:bg-accent-hover text-white text-xs font-semibold rounded-md transition-colors duration-200"
          >

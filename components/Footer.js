...
export default function Footer() {
  return (
    <footer className="bg-gray-950 border-t border-gray-800 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-300 font-semibold mb-4 text-sm uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gray-300 font-semibold mb-4 text-sm uppercase tracking-wider">Contact</h3>
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li className="text-gray-600">Dhaka, Bangladesh</li>
            </ul>
          </div>
        </div>

    ...
    <footer className="bg-gray-50 border-t border-gray-200 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-800 font-semibold mb-4 text-sm uppercase tracking-wider">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gray-800 font-semibold mb-4 text-sm uppercase tracking-wider">Contact</h3>

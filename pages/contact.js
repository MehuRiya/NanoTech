  ...
  return (
    <>
      ...
      <main className="pt-20 min-h-screen">
        {/* Header */}
        <section className="py-16 bg-gradient-to-br from-primary via-slate-800 to-blue-900/40">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-surface border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-accent transition-colors"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-surface border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-accent transition-colors resize-none"
                      />
                    </div>
                    <button
                      type="submit"
                      className="w-full py-3 bg-accent hover:bg-blue-400 text-white font-semibold rounded-lg transition-colors duration-200"
                    >
                      Send via WhatsApp
                    </button>
                  </form>
              ...
              <div>
                ...
                <div className="mt-8 bg-surface border border-slate-700 rounded-xl p-6 space-y-4">
                ...
                {/* Map placeholder */}
                <div className="mt-6 bg-surface border border-slate-700 rounded-xl overflow-hidden h-48 flex items-center justify-center">
